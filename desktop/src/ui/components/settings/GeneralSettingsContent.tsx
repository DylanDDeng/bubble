...
export function GeneralSettingsContent() {
  ...
  return <div className="space-y-8 pb-8">
    ...
    <SettingsGroup title="General">
      ...
      <SettingsRow variant="card" label="Prevent sleep while running" description="Keep your computer awake while Bubble runs a task.">{toggle('preventSleep', 'Prevent sleep while running')}</SettingsRow>
    </SettingsGroup>
    ...
    <SettingsGroup title="Notifications">
      ...
      <SettingsRow variant="card" label="Input required" description="Notify when Bubble is in the background."><SettingsToggle ariaLabel="Input required" checked={notifications?.inputRequired ?? true} disabled={disabled} onChange={value => void saveNotifications({ inputRequired: value })} /></SettingsRow>
      <SettingsRow variant="card" label="Approval required" description="Notify when Bubble is in the background."><SettingsToggle ariaLabel="Approval required" checked={notifications?.approvalRequired ?? true} disabled={disabled} onChange={value => void saveNotifications({ approvalRequired: value })} /></SettingsRow>
    </SettingsGroup>
