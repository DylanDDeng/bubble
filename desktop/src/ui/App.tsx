...
function GitHeaderActions({
  ...
  const handleGenerateCommitMessage = useCallback(async (
    ...
    try {
      ...
      throw new Error('Commit message generator is not available. Restart Bubble to load the latest preload.');
    } catch (error) {
      ...
      if (fallbackMessage) {
        ...
        setCommitGenerationError('Used a basic local suggestion. Restart Bubble if the Generate button still cannot use the full generator.');
        return;
      }
