...
// Bubble 的 MCP 配置位于当前环境 Bubble home 的 settings.json 中（仅全局，
...
const bubbleSettingsPath = () => join(resolveBubbleHome(), 'settings.json');
