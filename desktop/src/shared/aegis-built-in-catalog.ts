// AUTO-GENERATED from Bubble's model catalog by scripts/generate-aegis-catalog.mjs.
...
export const AEGIS_BUILT_IN_PROVIDERS: AegisBuiltInProviderDefinition[] = [
  ...
  { id: "minimax", name: "MiniMax Token Plan", baseUrl: "https://api.minimaxi.com/anthropic" },
  { id: "minimax-openai", name: "MiniMax (OpenAI Compatible)", baseUrl: "https://api.minimaxi.com/v1" },
  { id: "minimax-anthropic", name: "MiniMax (Anthropic Compatible)", baseUrl: "https://api.minimaxi.com/anthropic" },
...
export const AEGIS_BUILT_IN_MODELS: AegisBuiltInModelDefinition[] = [
  { id: "gpt-5.5", name: "gpt-5.5", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.4", name: "gpt-5.4", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.4-mini", name: "gpt-5.4-mini", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.3-codex", name: "gpt-5.3-codex", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.3-codex-spark", name: "gpt-5.3-codex-spark", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.2-codex", name: "gpt-5.2-codex", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.2", name: "gpt-5.2", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.1-codex-max", name: "gpt-5.1-codex-max", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.1-codex-mini", name: "gpt-5.1-codex-mini", providerId: "openai-codex", contextWindow: 272000 },
  { id: "gpt-5.1", name: "gpt-5.1", providerId: "openai-codex", contextWindow: 272000 },
  ...
  { id: "claude-fable-5", name: "Claude Fable 5", providerId: "anthropic", contextWindow: 1000000 },
  { id: "claude-opus-4-8", name: "Claude Opus 4.8", providerId: "anthropic", contextWindow: 1000000 },
  { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", providerId: "anthropic", contextWindow: 1000000 },
  { id: "claude-haiku-4-5-20251001", name: "Claude Haiku 4.5", providerId: "anthropic", contextWindow: 200000 },
  ...
  { id: "glm-5.2", name: "GLM-5.2", providerId: "zhipuai", contextWindow: 1000000 },
  ...
  { id: "glm-5.2", name: "GLM-5.2", providerId: "zhipuai-coding-plan", contextWindow: 1000000 },
  ...
  { id: "glm-5.2", name: "GLM-5.2", providerId: "zai", contextWindow: 1000000 },
  ...
  { id: "glm-5.2", name: "GLM-5.2", providerId: "zai-coding-plan", contextWindow: 1000000 },
  ...
  { id: "qwen3.6-plus", name: "Qwen3.6 Plus", providerId: "alibaba", contextWindow: 1048576 },
  { id: "qwen3.7-max", name: "Qwen3.7 Max", providerId: "alibaba", contextWindow: 1048576 },
  { id: "MiniMax-M3", name: "MiniMax M3", providerId: "minimax", contextWindow: 1000000 },
  { id: "MiniMax-M2.7", name: "MiniMax M2.7", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2.7-highspeed", name: "MiniMax M2.7 Highspeed", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2.5", name: "MiniMax M2.5", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2.5-highspeed", name: "MiniMax M2.5 Highspeed", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2.1", name: "MiniMax M2.1", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2.1-highspeed", name: "MiniMax M2.1 Highspeed", providerId: "minimax", contextWindow: 204800 },
  { id: "MiniMax-M2", name: "MiniMax M2", providerId: "minimax", contextWindow: 204800 },
  { id: "M2-her", name: "M2-her", providerId: "minimax", contextWindow: 64000 },
  { id: "MiniMax-M3", name: "MiniMax M3", providerId: "minimax-openai", contextWindow: 1000000 },
  { id: "MiniMax-M2.7", name: "MiniMax M2.7", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2.7-highspeed", name: "MiniMax M2.7 Highspeed", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2.5", name: "MiniMax M2.5", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2.5-highspeed", name: "MiniMax M2.5 Highspeed", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2.1", name: "MiniMax M2.1", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2.1-highspeed", name: "MiniMax M2.1 Highspeed", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "MiniMax-M2", name: "MiniMax M2", providerId: "minimax-openai", contextWindow: 204800 },
  { id: "M2-her", name: "M2-her", providerId: "minimax-openai", contextWindow: 64000 },
  { id: "MiniMax-M3", name: "MiniMax M3", providerId: "minimax-anthropic", contextWindow: 1000000 },
  { id: "MiniMax-M2.7", name: "MiniMax M2.7", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2.7-highspeed", name: "MiniMax M2.7 Highspeed", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2.5", name: "MiniMax M2.5", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2.5-highspeed", name: "MiniMax M2.5 Highspeed", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2.1", name: "MiniMax M2.1", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2.1-highspeed", name: "MiniMax M2.1 Highspeed", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "MiniMax-M2", name: "MiniMax M2", providerId: "minimax-anthropic", contextWindow: 204800 },
  { id: "M2-her", name: "M2-her", providerId: "minimax-anthropic", contextWindow: 64000 },
  { id: "step-3.7-flash", name: "Step 3.7 Flash", providerId: "stepfun", contextWindow: 256000 },
  { id: "step-3.5-flash-2603", name: "Step 3.5 Flash 2603", providerId: "stepfun", contextWindow: 0 },
  { id: "step-3.5-flash", name: "Step 3.5 Flash", providerId: "stepfun", contextWindow: 0 },
  { id: "step-router-v1", name: "Step Router V1", providerId: "stepfun", contextWindow: 0 },
  { id: "kimi-k2.7-code", name: "Kimi K2.7 Code", providerId: "moonshot-cn", contextWindow: 262144 },
  { id: "kimi-k2.7-code-highspeed", name: "Kimi K2.7 Code Highspeed", providerId: "moonshot-cn", contextWindow: 262144 },
  ...
  { id: "kimi-k2.7-code", name: "Kimi K2.7 Code", providerId: "moonshot-intl", contextWindow: 262144 },
  { id: "kimi-k2.7-code-highspeed", name: "Kimi K2.7 Code Highspeed", providerId: "moonshot-intl", contextWindow: 262144 },
  ...
  { id: "kimi-k2.7-code", name: "Kimi K2.7 Code", providerId: "kimi-for-coding", contextWindow: 262144 },
  { id: "kimi-k2.7-code-highspeed", name: "Kimi K2.7 Code Highspeed", providerId: "kimi-for-coding", contextWindow: 262144 },
  { id: "kimi-k2.6", name: "Kimi K2.6", providerId: "kimi-for-coding", contextWindow: 256000 },
  { id: "kimi-k2.5", name: "Kimi K2.5", providerId: "kimi-for-coding", contextWindow: 256000 },
  ...
  { id: "meta-llama/Llama-3.3-70B-Instruct-Turbo", name: "meta-llama/Llama-3.3-70B-Instruct-Turbo", providerId: "together", contextWindow: 32768 },
  { id: "Qwen/Qwen2.5-72B-Instruct", name: "Qwen/Qwen2.5-72B-Instruct", providerId: "together", contextWindow: 32768 },
...
export const AEGIS_BUILT_IN_DEFAULT_PROVIDER_ID = "zhipuai";
export const AEGIS_BUILT_IN_DEFAULT_MODEL_ID = "glm-5.2";
