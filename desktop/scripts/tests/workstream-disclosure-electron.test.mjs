...
app.whenReady().then(async()=>{
 ...
 try{
  ...
  assert.equal(await js('document.querySelector("#error [data-workstream-group]").textContent'),'Called tools(1 failed)','collapsed group retains its activity and failure count');
