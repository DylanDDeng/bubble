...
const defaultGuidelines = [
  ...
  "For modifications to existing code, read the file first. For brand-new files whose target path is known and does not exist, write directly without exploratory reading. Default to editing an existing file over creating a new one.",
